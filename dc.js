setTimeout(
	...
	function GetCount(date,id){
     ...
     // else date is still good
          ...
          template="<div id='countbox'><div id='counttitle'><h2>倒數開跑</h2></div><p>"+days+"<span class='word'>天</span> "+hours+"<span class='word'>小時</span> "+mins+"<span class='word'>分</span> "+secs+"<span class='word'>"+ "秒</span> "+"</p></div>"
